...
from examples.stg.order_system_restaurants_dag.orders_saver import OrdersSaver
...
class OrderLoader:
    ...
    def __init__(self, collection_loader: OrderReader, pg_dest: PgConnect, orders_saver: OrdersSaver, logger: Logger) -> None:
        self.collection_loader = collection_loader
        self.orders_saver = orders_saver
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            i = 0
            for d in load_queue:
                self.orders_saver.save_object(conn, str(d["_id"]), d["update_ts"], d)
